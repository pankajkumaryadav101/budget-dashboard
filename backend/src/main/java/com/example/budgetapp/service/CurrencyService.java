...
public class CurrencyService {
    ...
    public Map<String, Double> getLatestRates(String baseCurrency) {
        if (!baseCurrency.equalsIgnoreCase(base) || (System.currentTimeMillis() - lastFetched) > 5 * 60 * 1000) {
            fetchLatestRates(baseCurrency);
        }
        // if requested base differs, convert on the fly
    ...
    public double convert(String from, String to, double amount) {
        ...
        // rates are relative to base; to convert: amount / fromRate * toRate
